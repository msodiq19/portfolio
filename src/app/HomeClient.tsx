...
export default function HomeClient({ latestPosts }: HomeClientProps) {
  ...
  const navLinks = ["About", "Experience", "Projects", "Blog", "Contact"];
  ...
  return (
    <>
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        {navLinks.map((link) => (
          link === "Blog" ? (
            <Link key={link} href="/blog" onClick={() => setMenuOpen(false)}>
              {link}
            </Link>
          ) : (
          ...
          <div className="projects-grid">
            {(activeFilter === "All"
              ...
              : activeFilter === "Featured"
                ? projects.filter((p) => p.visible !== false && p.featured)
                : projects.filter((p) =>
                  p.visible !== false && p.category.toLowerCase().includes(activeFilter.toLowerCase())
                )
            ).map((project, i) => (
                ...
                <div className="project-image">
                  ...
                  <div className="project-image-overlay">
                    {project.live && (
                      ...
                      >
                        <ExternalLink size={14} /> {project.category === "Architecture Docs" ? "Read Article" : "Live"}
                      </a>
                    )}
                    {project.private ? (
                      <span
                        className="btn btn-ghost"
                        style={{ fontSize: "13px", padding: "9px 18px", background: "rgba(0,0,0,0.5)", opacity: 0.6, cursor: "default" }}
                        title="Private client project — source not publicly available"
                      >
                        🔒 Private
                      </span>
                    ) : project.github && (
                ...
                <div className="project-content">
                  ...
                  <div className="project-links">
                    {project.private ? (
                      <span
                        className="btn btn-ghost"
                        style={{ fontSize: "13px", padding: "8px 14px", flex: 1, justifyContent: "center", opacity: 0.5, cursor: "default" }}
                        title="Private client project — source not publicly available"
                      >
                        🔒 Private Repo
                      </span>
                    ...
                    {project.live && (
                      <a
                        ...
                        style={{ fontSize: "13px", padding: "8px 14px", flex: 1, justifyContent: "center" }}
                      >
                        <ArrowUpRight size={14} /> {project.category === "Architecture Docs" ? "Read Article" : "Live Demo"}
                      </a>
                    )}
                  </div>
                </div>
